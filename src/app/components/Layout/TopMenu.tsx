...
export const TopMenu = async () => {
    ...
    const totalItems: number = getTotalCount()
    return (
        <div className="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
          <div className="px-6 flex items-center justify-between space-x-4">
            ...
            <div className="flex space-x-2">
              ...
              <Link href='/dashboard/cart' className="flex p-2 items-center justify-center h-10 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
                {
                  totalItems ?
